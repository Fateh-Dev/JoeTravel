...
namespace Joe.Travel.Migrations
{
    ...
    [Migration("20220910183222_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Joe.Travel.Models.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.Activities", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.Guide", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Joe.Travel.Models.IncludedStuff", b =>
                {
                    ...
                    b.ToTable("Joe.Travel.IncludedStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.Loging", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.Logings", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.NotAllowedStuff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.NotAllowedStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.NotSuitableFor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.NotSuitableFor", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.RequiredStuff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.RequiredStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.Risk", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Joe.Travel.Risks", (string)null);
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.Trip", b =>
                {
                    ...
                    b.ToTable("Joe.Travel.Trips", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripActivity", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TripId", "ActivityId");

                    b.ToTable("Joe.Travel.Trip_Activities", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripIncludedStuff", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("IncludedStuffId")
                        .HasColumnType("uuid");

                    b.HasKey("TripId", "IncludedStuffId");

                    b.HasIndex("IncludedStuffId");

                    b.HasIndex("TripId", "IncludedStuffId");

                    b.ToTable("Joe.Travel.Trip_IncludedStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripLoging", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("LogingId")
                        .HasColumnType("uuid");

                    b.HasKey("TripId", "LogingId");

                    b.HasIndex("LogingId");

                    b.HasIndex("TripId", "LogingId");

                    b.ToTable("Joe.Travel.Trip_Loging", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripNotAllowedStuff", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("NotAllowedStuffId")
                        .HasColumnType("uuid");

                    b.HasKey("TripId", "NotAllowedStuffId");

                    b.HasIndex("NotAllowedStuffId");

                    b.HasIndex("TripId", "NotAllowedStuffId");

                    b.ToTable("Joe.Travel.Trip_NotAllowedStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripNotSuitableFor", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("NotSuitableForId")
                        .HasColumnType("uuid");

                    b.HasKey("TripId", "NotSuitableForId");

                    b.HasIndex("NotSuitableForId");

                    b.HasIndex("TripId", "NotSuitableForId");

                    b.ToTable("Joe.Travel.Trip_NotSuitableFor", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripRequiredStuff", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RequiredStuffId")
                        .HasColumnType("uuid");

                    b.HasKey("TripId", "RequiredStuffId");

                    b.HasIndex("RequiredStuffId");

                    b.HasIndex("TripId", "RequiredStuffId");

                    b.ToTable("Joe.Travel.Trip_RequiredStuff", (string)null);
                });

            modelBuilder.Entity("Joe.Travel.Models.TripRisk", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("TripId", "RiskId");

                    b.HasIndex("RiskId");

                    b.HasIndex("TripId", "RiskId");

                    b.ToTable("Joe.Travel.Trip_Risks", (string)null);
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripActivity", b =>
                {
                    b.HasOne("Joe.Travel.Models.Activity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripIncludedStuff", b =>
                {
                    b.HasOne("Joe.Travel.Models.IncludedStuff", null)
                        .WithMany()
                        .HasForeignKey("IncludedStuffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Joe.Travel.Models.Trip", null)
                        .WithMany("IncludedStuffs")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripLoging", b =>
                {
                    b.HasOne("Joe.Travel.Models.Loging", null)
                        .WithMany()
                        .HasForeignKey("LogingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripNotAllowedStuff", b =>
                {
                    b.HasOne("Joe.Travel.Models.NotAllowedStuff", null)
                        .WithMany()
                        .HasForeignKey("NotAllowedStuffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Joe.Travel.Models.Trip", null)
                        .WithMany("NotAllowedStuffs")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripNotSuitableFor", b =>
                {
                    b.HasOne("Joe.Travel.Models.NotSuitableFor", null)
                        .WithMany()
                        .HasForeignKey("NotSuitableForId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Joe.Travel.Models.Trip", null)
                        .WithMany("NotSuitableFors")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripRequiredStuff", b =>
                {
                    b.HasOne("Joe.Travel.Models.RequiredStuff", null)
                        .WithMany()
                        .HasForeignKey("RequiredStuffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Joe.Travel.Models.Trip", null)
                        .WithMany("RequiredStuffs")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Joe.Travel.Models.TripRisk", b =>
                {
                    b.HasOne("Joe.Travel.Models.Risk", null)
                        .WithMany()
