...
namespace Joe.Travel.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Activities",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    DescriptionAr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Activities", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.Guides",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Guides", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.IncludedStuff",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.IncludedStuff", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.Logings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Logings", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.NotAllowedStuff",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.NotAllowedStuff", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.NotSuitableFor",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.NotSuitableFor", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.RequiredStuff",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.RequiredStuff", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "Joe.Travel.Risks",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DescriptionFr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Risks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trips_Joe.Travel.Guides_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Joe.Travel.Guides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_Activities", x => new { x.TripId, x.ActivityId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Activities_Joe.Travel.Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Joe.Travel.Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Activities_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Trip_IncludedStuff",
                columns: table => new
                {
                    TripId = table.Column<Guid>(type: "uuid", nullable: false),
                    IncludedStuffId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_IncludedStuff", x => new { x.TripId, x.IncludedStuffId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_IncludedStuff_Joe.Travel.IncludedStuff_Incl~",
                        column: x => x.IncludedStuffId,
                        principalTable: "Joe.Travel.IncludedStuff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_IncludedStuff_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Trip_Loging",
                columns: table => new
                {
                    TripId = table.Column<Guid>(type: "uuid", nullable: false),
                    LogingId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_Loging", x => new { x.TripId, x.LogingId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Loging_Joe.Travel.Logings_LogingId",
                        column: x => x.LogingId,
                        principalTable: "Joe.Travel.Logings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Loging_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Trip_NotAllowedStuff",
                columns: table => new
                {
                    TripId = table.Column<Guid>(type: "uuid", nullable: false),
                    NotAllowedStuffId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_NotAllowedStuff", x => new { x.TripId, x.NotAllowedStuffId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_NotAllowedStuff_Joe.Travel.NotAllowedStuff_~",
                        column: x => x.NotAllowedStuffId,
                        principalTable: "Joe.Travel.NotAllowedStuff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_NotAllowedStuff_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Trip_NotSuitableFor",
                columns: table => new
                {
                    TripId = table.Column<Guid>(type: "uuid", nullable: false),
                    NotSuitableForId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_NotSuitableFor", x => new { x.TripId, x.NotSuitableForId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_NotSuitableFor_Joe.Travel.NotSuitableFor_No~",
                        column: x => x.NotSuitableForId,
                        principalTable: "Joe.Travel.NotSuitableFor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_NotSuitableFor_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Joe.Travel.Trip_RequiredStuff",
                columns: table => new
                {
                    TripId = table.Column<Guid>(type: "uuid", nullable: false),
                    RequiredStuffId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_RequiredStuff", x => new { x.TripId, x.RequiredStuffId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_RequiredStuff_Joe.Travel.RequiredStuff_Requ~",
                        column: x => x.RequiredStuffId,
                        principalTable: "Joe.Travel.RequiredStuff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_RequiredStuff_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joe.Travel.Trip_Risks", x => new { x.TripId, x.RiskId });
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Risks_Joe.Travel.Risks_RiskId",
                        column: x => x.RiskId,
                        principalTable: "Joe.Travel.Risks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Joe.Travel.Trip_Risks_Joe.Travel.Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Joe.Travel.Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_Activities_TripId_ActivityId",
                table: "Joe.Travel.Trip_Activities",
                columns: new[] { "TripId", "ActivityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_IncludedStuff_IncludedStuffId",
                table: "Joe.Travel.Trip_IncludedStuff",
                column: "IncludedStuffId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_IncludedStuff_TripId_IncludedStuffId",
                table: "Joe.Travel.Trip_IncludedStuff",
                columns: new[] { "TripId", "IncludedStuffId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_Loging_LogingId",
                table: "Joe.Travel.Trip_Loging",
                column: "LogingId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_Loging_TripId_LogingId",
                table: "Joe.Travel.Trip_Loging",
                columns: new[] { "TripId", "LogingId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_NotAllowedStuff_NotAllowedStuffId",
                table: "Joe.Travel.Trip_NotAllowedStuff",
                column: "NotAllowedStuffId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_NotAllowedStuff_TripId_NotAllowedStuffId",
                table: "Joe.Travel.Trip_NotAllowedStuff",
                columns: new[] { "TripId", "NotAllowedStuffId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_NotSuitableFor_NotSuitableForId",
                table: "Joe.Travel.Trip_NotSuitableFor",
                column: "NotSuitableForId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_NotSuitableFor_TripId_NotSuitableForId",
                table: "Joe.Travel.Trip_NotSuitableFor",
                columns: new[] { "TripId", "NotSuitableForId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_RequiredStuff_RequiredStuffId",
                table: "Joe.Travel.Trip_RequiredStuff",
                column: "RequiredStuffId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_RequiredStuff_TripId_RequiredStuffId",
                table: "Joe.Travel.Trip_RequiredStuff",
                columns: new[] { "TripId", "RequiredStuffId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_Risks_RiskId",
                table: "Joe.Travel.Trip_Risks",
                column: "RiskId");

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trip_Risks_TripId_RiskId",
                table: "Joe.Travel.Trip_Risks",
                columns: new[] { "TripId", "RiskId" });

            migrationBuilder.CreateIndex(
                name: "IX_Joe.Travel.Trips_GuideId",
                table: "Joe.Travel.Trips",
                column: "GuideId");
        }
